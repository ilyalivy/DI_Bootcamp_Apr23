...
class Game:
    ...
    def get_game_result(self):
        if self.user_item == self.computer_item:
            return 'Tie'
        elif self.user_item == 'r' and self.computer_item == 's' or self.user_item == 'p' and self.computer_item == 'r' or self.user_item == 's' and self.computer_item == 'p' or self.user_item == 'r' and self.computer_item == 'p':
            return 'Win'
        else:
            return 'Loss'
